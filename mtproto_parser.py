...
class MTProtoProxyManager:
    ...
    def fetch_mtproto_proxies(self):
        ...
        known_proxies = [
            {
                'host': 'mtproxy.tginfo.me',
                'port': 443,
                'secret': 'dd00000000000000000000000000000000',
                'type': 'mtproto',
                'link': 'tg://proxy?server=mtproxy.tginfo.me&port=443&secret=dd00000000000000000000000000000000'
            },
            {
                'host': 'tgproxy.me',
                'port': 443,
                ...
                'type': 'mtproto',
                'link': 'tg://proxy?server=tgproxy.me&port=443&secret=ee00000000000000000000000000000000'
            },
            {
                'host': 'proxy.digitalresistance.dog',
                'port': 443,
                'secret': 'dd91f9a8e0864d13fa4ea569e744e8e5e5',
                'type': 'mtproto',
                'link': 'tg://proxy?server=proxy.digitalresistance.dog&port=443&secret=dd91f9a8e0864d13fa4ea569e744e8e5e5'
            },
            {
                'host': 'mtproxy.tgcn.org',
                'port': 443,
                'secret': 'ee1e7e8d8d3a4c5e5e5e5e5e5e5e5e5e5e',
                'type': 'mtproto',
                'link': 'tg://proxy?server=mtproxy.tgcn.org&port=443&secret=ee1e7e8d8d3a4c5e5e5e5e5e5e5e5e5e5e'
            }
        ]
